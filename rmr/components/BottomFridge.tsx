...
// Bottom fridge component with decorative handle and shine effects
export default function BottomFridge({
  ...
  return (
    ...
    >
      {/* Decorative Fridge Handle */}
      <div className="absolute w-auto h-[35rem] left-0 ml-20 top-0 mt-[5rem]">
      ...
      {/* Left Side Decorative Shine Effects */}
      <div
      ...
      {/* Right Side Decorative Shine Effects */}
      <div
