...
export default function Home() {
  ...
  {/* Row with input and button side-by-side */}
  <div className="flex">
    <Input
  ...
  {/* Error message goes underneath the whole row */}
  {!email.endsWith(".edu") && email.length > 0 && (
    <p className="text-red-600 font-lazyDog text-sm ml-1">
      Please enter a valid <span className="underline">.edu</span> email address!
    </p>
  )}
</div>
